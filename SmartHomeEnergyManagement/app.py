...
def register():
    ...
    if form.validate_on_submit():
        ...
        if existing_user:
            ...
            con = sqlite3.connect("/Users/aryan/Desktop/SmartHomeEnergyManagement/instance/site.db")
            cur = con.cursor()
...
def energy_consumption(service_location_id, time_resolution):
    ...
    if time_resolution == 'day':
        query = """
            ...
            GROUP BY date
        """
        con2 = sqlite3.connect("/Users/aryan/Desktop/SmartHomeEnergyManagement/instance/site.db")
        cur2 = con2.cursor()
...
def monthly_energy_cost(service_location_id):
    ...
    """
    con3 = sqlite3.connect("/Users/aryan/Desktop/SmartHomeEnergyManagement/instance/site.db")
    cur3 = con3.cursor()
